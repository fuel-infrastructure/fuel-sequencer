...
import (
	...
	"github.com/fuel-infrastructure/fuel-sequencer/app/upgrades/token_updates"
...
func NewFuelSequencerApp(
	...
	app.UpgradeKeeper.SetUpgradeHandler(
		token_updates.UpgradeName,
		token_updates.CreateUpgradeHandler(app.ModuleManager, app.Configurator(), app.AccountKeeper),
	)
