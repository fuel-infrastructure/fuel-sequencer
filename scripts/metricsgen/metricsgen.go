// metricsgen is a code generation tool for creating constructors for metrics types.
// Ref: https://github.com/cometbft/cometbft/blob/v0.38.10/scripts/metricsgen/metricsgen.go
package main
