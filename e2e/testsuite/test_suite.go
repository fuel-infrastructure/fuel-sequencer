...
var (
	...
	// ETH_GUARDIAN corresponds to the address assigned as the guardian in the FuelStreamX contract.
...
func (s *E2ETestSuite) runEthNodeContainer() {
	...
	s.Require().Eventually(
		func() bool {
			...
			balance, err := ethClient.BalanceAt(ctx, ETH_KEYS[0].Address, nil)
			if err != nil {
