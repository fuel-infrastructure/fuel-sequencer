...
EXPLORER_TX_URL = "http://localhost:1317/cosmos/tx/v1beta1/txs/"
SEQ_node = "http://localhost:26657"
...
# Max blob size:
#   http://localhost:1317/fuelsequencer/sequencing/v1/params
# Max block size:
#   https://localhost:26657/consensus_params
