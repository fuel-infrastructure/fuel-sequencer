...
func (x *fastReflection_GenesisState) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.LastEthereumBlockSynced) != 0 {
		value := protoreflect.ValueOfBytes(x.LastEthereumBlockSynced)
		if !f(fd_GenesisState_last_ethereum_block_synced, value) {
			return
		}
	}
	if len(x.EthereumEventIndexOffset) != 0 {
		value := protoreflect.ValueOfBytes(x.EthereumEventIndexOffset)
...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "fuelsequencer.bridge.GenesisState.ethereum_event_index_offset":
		return len(x.EthereumEventIndexOffset) != 0
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_GenesisState) Clear(fd protoreflect.FieldDescriptor) {
	...
	case "fuelsequencer.bridge.GenesisState.ethereum_event_index_offset":
		x.EthereumEventIndexOffset = nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fuelsequencer.bridge.GenesisState"))
		}
...
func (x *fastReflection_GenesisState) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "fuelsequencer.bridge.GenesisState.ethereum_event_index_offset":
		x.EthereumEventIndexOffset = value.Bytes()
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fuelsequencer.bridge.GenesisState"))
		}
...
func (x *fastReflection_GenesisState) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		l = len(x.LastEthereumBlockSynced)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
		l = len(x.EthereumEventIndexOffset)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.EthereumEventIndexOffset) > 0 {
			i -= len(x.EthereumEventIndexOffset)
			copy(dAtA[i:], x.EthereumEventIndexOffset)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.EthereumEventIndexOffset)))
			i--
			dAtA[i] = 0x2a
		}
		if len(x.LastEthereumBlockSynced) > 0 {
			i -= len(x.LastEthereumBlockSynced)
			copy(dAtA[i:], x.LastEthereumBlockSynced)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.LastEthereumBlockSynced)))
			i--
			dAtA[i] = 0x22
		}
		if len(x.LastEthereumNonce) > 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 4:
				...
				x.LastEthereumBlockSynced = append(x.LastEthereumBlockSynced[:0], dAtA[iNdEx:postIndex]...)
				if x.LastEthereumBlockSynced == nil {
			...
			case 5:
				...
				x.EthereumEventIndexOffset = append(x.EthereumEventIndexOffset[:0], dAtA[iNdEx:postIndex]...)
				if x.EthereumEventIndexOffset == nil {
					x.EthereumEventIndexOffset = []byte{}
				}
				iNdEx = postIndex
			default:
				iNdEx = preIndex
...
type GenesisState struct {
	...
	EthereumEventIndexOffset []byte `protobuf:"bytes,5,opt,name=ethereum_event_index_offset,json=ethereumEventIndexOffset,proto3" json:"ethereum_event_index_offset,omitempty"`
}
...
func (x *GenesisState) GetLastEthereumBlockSynced() []byte {
	if x != nil {
...
func (x *GenesisState) GetEthereumEventIndexOffset() []byte {
	if x != nil {
...
var file_fuelsequencer_bridge_genesis_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x1a, 0x31, 0x66, 0x75, 0x65, 0x6c, 0x73, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x65,
	0x72, 0x2f, 0x62, 0x72, 0x69, 0x64, 0x67, 0x65, 0x2f, 0x73, 0x75, 0x70, 0x70, 0x6c, 0x79, 0x5f,
	0x64, 0x65, 0x6c, 0x74, 0x61, 0x5f, 0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x65, 0x64, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe4, 0x03, 0x0a, 0x0c, 0x47, 0x65, 0x6e, 0x65, 0x73, 0x69,
	...
	0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x51, 0x0a, 0x11, 0x73, 0x75, 0x70, 0x70, 0x6c,
	0x79, 0x5f, 0x64, 0x65, 0x6c, 0x74, 0x61, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x02, 0x20, 0x01,
	...
	,
	...
	,
