...
replace (
	...
	cosmossdk.io/x/bank => github.com/fuel-infrastructure/cosmos-sdk/x/bank v0.52.0-custom-3
	cosmossdk.io/x/distribution => github.com/fuel-infrastructure/cosmos-sdk/x/distribution v0.52.0-custom-3
	cosmossdk.io/x/slashing => github.com/fuel-infrastructure/cosmos-sdk/x/slashing v0.52.0-custom-3
	cosmossdk.io/x/staking => github.com/fuel-infrastructure/cosmos-sdk/x/staking v0.52.0-custom-4
	github.com/cosmos/cosmos-sdk => github.com/fuel-infrastructure/cosmos-sdk v0.52.0-custom-1
...
require (
	...
	cosmossdk.io/collections v1.1.0 // indirect; main
	cosmossdk.io/core v1.0.0 // main
	cosmossdk.io/core/testing v0.0.1 // indirect; main
	cosmossdk.io/depinject v1.1.0 // indirect
	cosmossdk.io/errors v1.0.1
	cosmossdk.io/indexer/postgres v0.1.0 // indirect; main
