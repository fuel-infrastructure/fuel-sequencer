...
type E2ETestSuite struct {
	...
	// EthDeployer corresponds to the address deploying the Ethereum contracts.
	...
	// EthUser corresponds to an address that does not have any particular elevated privileges.
