...
var (
	...
	fd_GenesisState_last_consensus_txs_sequence protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_GenesisState_last_consensus_txs_sequence = md_GenesisState.Fields().ByName("last_consensus_txs_sequence")
}
...
func (x *fastReflection_GenesisState) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.LastConsensusTxsSequence != uint64(0) {
		value := protoreflect.ValueOfUint64(x.LastConsensusTxsSequence)
		if !f(fd_GenesisState_last_consensus_txs_sequence, value) {
			return
		}
	}
}
...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "fuelsequencer.bridge.GenesisState.last_consensus_txs_sequence":
		return x.LastConsensusTxsSequence != uint64(0)
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_GenesisState) Clear(fd protoreflect.FieldDescriptor) {
	...
	case "fuelsequencer.bridge.GenesisState.last_consensus_txs_sequence":
		x.LastConsensusTxsSequence = uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fuelsequencer.bridge.GenesisState"))
		}
...
func (x *fastReflection_GenesisState) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "fuelsequencer.bridge.GenesisState.last_eth_block_update_time":
		...
		return protoreflect.ValueOfMessage(value.ProtoReflect())
	case "fuelsequencer.bridge.GenesisState.last_consensus_txs_sequence":
		value := x.LastConsensusTxsSequence
		return protoreflect.ValueOfUint64(value)
	default:
...
func (x *fastReflection_GenesisState) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "fuelsequencer.bridge.GenesisState.last_consensus_txs_sequence":
		x.LastConsensusTxsSequence = value.Uint()
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fuelsequencer.bridge.GenesisState"))
		}
...
func (x *fastReflection_GenesisState) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "fuelsequencer.bridge.GenesisState.last_consensus_txs_sequence":
		panic(fmt.Errorf("field last_consensus_txs_sequence of message fuelsequencer.bridge.GenesisState is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fuelsequencer.bridge.GenesisState"))
		}
...
func (x *fastReflection_GenesisState) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.LastConsensusTxsSequence != 0 {
			n += 1 + runtime.Sov(uint64(x.LastConsensusTxsSequence))
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.LastConsensusTxsSequence != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.LastConsensusTxsSequence))
			i--
			dAtA[i] = 0x38
		}
		if x.LastEthBlockUpdateTime != nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 7:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field LastConsensusTxsSequence", wireType)
				}
				x.LastConsensusTxsSequence = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, runtime.ErrIntOverflow
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.LastConsensusTxsSequence |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
func (x *GenesisState) GetLastConsensusTxsSequence() uint64 {
	if x != nil {
		return x.LastConsensusTxsSequence
	}
	return 0
}
...
var file_fuelsequencer_bridge_genesis_proto_rawDesc = []byte{
	...
	0x22, 0xa1, 0x04, 0x0a, 0x0c, 0x47, 0x65, 0x6e, 0x65, 0x73, 0x69, 0x73, 0x53, 0x74, 0x61, 0x74,
	...
	0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x3d, 0x0a, 0x1b, 0x6c, 0x61, 0x73, 0x74, 0x5f, 0x63, 0x6f,
	0x6e, 0x73, 0x65, 0x6e, 0x73, 0x75, 0x73, 0x5f, 0x74, 0x78, 0x73, 0x5f, 0x73, 0x65, 0x71, 0x75,
	0x65, 0x6e, 0x63, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x04, 0x52, 0x18, 0x6c, 0x61, 0x73, 0x74,
	0x43, 0x6f, 0x6e, 0x73, 0x65, 0x6e, 0x73, 0x75, 0x73, 0x54, 0x78, 0x73, 0x53, 0x65, 0x71, 0x75,
