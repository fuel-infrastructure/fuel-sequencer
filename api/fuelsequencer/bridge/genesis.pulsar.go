...
var (
	...
	fd_GenesisState_eth_events_tx              protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_GenesisState_eth_events_tx = md_GenesisState.Fields().ByName("eth_events_tx")
}
...
var file_fuelsequencer_bridge_genesis_proto_rawDesc = []byte{
	...
	0xc0, 0x01, 0x0a, 0x18, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x75, 0x65, 0x6c, 0x73, 0x65, 0x71, 0x75,
	0x65, 0x6e, 0x63, 0x65, 0x72, 0x2e, 0x62, 0x72, 0x69, 0x64, 0x67, 0x65, 0x42, 0x0c, 0x47, 0x65,
...
var file_fuelsequencer_bridge_genesis_proto_goTypes = []interface{}{
	...
	(*EthEventsTx)(nil),     // 3: fuelsequencer.bridge.EthEventsTx
}
var file_fuelsequencer_bridge_genesis_proto_depIdxs = []int32{
	...
	3, // 2: fuelsequencer.bridge.GenesisState.eth_events_tx:type_name -> fuelsequencer.bridge.EthEventsTx
