...
func TestObserveTotalBlobsPosted(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			topic:          []byte{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x26, 0xa1},
...
func TestHexEncodingProducesValidMetricNames(t *testing.T) {
	...
	problematicTopic := []byte{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x26, 0xa1}
	...
	require.True(t, hasNullBytes, "direct string conversion should contain null bytes (demonstrating the original problem)")
	...
	require.Equal(t, []string{"sequencer", "tx", "msg", "total", "blobs", "posted", "00000000000000000000000000000000000000000000000000000000000026a1"}, expectedKeys)

	expectedSizeKeys := append(utils.KeysTxMsg, "total", "blobs", "posted", "size", hexString)
	require.Equal(t, []string{"sequencer", "tx", "msg", "total", "blobs", "posted", "size", "00000000000000000000000000000000000000000000000000000000000026a1"}, expectedSizeKeys)
}
