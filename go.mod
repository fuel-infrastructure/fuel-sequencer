...
replace (
	...
	// use custom blob-storage with the targeted fixes (branch: feature/syncmap-store)
	github.com/fuel-infrastructure/blob-storage => github.com/fuel-infrastructure/blob-storage v0.0.0-20250910194627-c5e4895c352d
